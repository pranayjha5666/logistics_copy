...
import '../Shimmer/shimmer_two_wheeler_map.dart';

class TwoWheelerDeliveredMap extends StatefulWidget {
  const TwoWheelerDeliveredMap({super.key});

  @override
  State<TwoWheelerDeliveredMap> createState() => _TwoWheelerDeliveredMap();
}

class _TwoWheelerDeliveredMap extends State<TwoWheelerDeliveredMap> {
  var location = Get.find<TwoWheelerBookingController>()
  ...
  Widget build(BuildContext context) {
    if (_pickupIcon == null || _dropIcon == null) {
      return const Center(child: ShimmerTwoWheelerMap());
    }
